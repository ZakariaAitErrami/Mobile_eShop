      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text("No shipment address has benn saved."),
        ...
        child: Column(
          children: [
            ...
            ? WideButton(
              message: "Procceed",
              onPressed: (){
                Route route = MaterialPageRoute(builder: (c) => PaymentPage( //paymentPage is the placeorderpayment file in Orders package
