                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Align(
                              ...
                              child: Text(
                                "Order total price: " + dataMap[EcommerceApp.totalAmount].toString() + " MAD",
                          ...
                          FutureBuilder<QuerySnapshot>(
                            future: EcommerceApp.firestore.collection("items")
                                .where("shortInfo", whereIn: dataMap[EcommerceApp.productID]).getDocuments(),
...
class ShippingDetails extends StatelessWidget {
    ...
    return Column(
      ...
      children: [
        ...
        Padding(
          ...
          child: InkWell(
            onTap: (){
              confirmerduserOrderReceived(context, getOrderId);
            },
            child: Container(
              decoration: new BoxDecoration(
                gradient: new LinearGradient(
  ...
  confirmerduserOrderReceived(BuildContext context, String mOrderId){
