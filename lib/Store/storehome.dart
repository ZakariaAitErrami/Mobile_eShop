    ...
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          ...
          centerTitle: true,
          //right sidde of the appbar we use actions
          actions: [
            Stack(
              children: [
                IconButton(
                  ...
                  child: Stack(
                    children: [
                      ...
                      Positioned(
                        top: 3.0,
                        bottom: 4.0,
                        left: 4.0, // the postion of the counter
        ...
        drawer: MyDrawer(), //in the widgets packages
        body: CustomScrollView(
          slivers: [
            //SearchBoxDelegate a class called searchbox in the widgets package
            ...
            Expanded(
                child: Column(
                  ...
                  children: [
                            ...
                            Padding(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  Text(
                                    (model.price + model.price).toString() + " MAD",
                                    style: TextStyle(
                                        fontSize: 14.0,
                                        color: Colors.grey,
                                        decoration: TextDecoration.lineThrough,
                    ...
                    // to implement the cart item add and remove feature
                    Align(
...
void checkItemInCart(String shortInfoAsID, BuildContext context) {
  EcommerceApp.sharedPreferences.getStringList(EcommerceApp.userCartList).contains(shortInfoAsID)
      ? Fluttertoast.showToast(msg: "This Merchandise is already in Cart")
...
addItemToCart(String shortInfoAsID, BuildContext context){
  ...
  EcommerceApp.firestore.collection(EcommerceApp.collectionUser)
    ...
    Fluttertoast.showToast(msg: "Merchandise Added to cart Successfully.");
