...
class _RegisterState extends State<Register> {
    ...
    showDialog(
        ...
        builder: (c) {
          return LoadingAlertDialog(
              message:
                  "Registering, Please wait...!"); //class in DialogBox package
        });
  ...
  Future saveUserInfoToFireStore(FirebaseUser fUser) async {
    ...
    await EcommerceApp.sharedPreferences.setString(EcommerceApp.userEmail,
        fUser.email); //EcommerceApp.userEmail contains the string "email"
    await EcommerceApp.sharedPreferences
        .setString(EcommerceApp.userName, p.name);
    await EcommerceApp.sharedPreferences
        .setString(EcommerceApp.userAvatarUrl, p.imUrl);
    await EcommerceApp.sharedPreferences.setStringList(
        EcommerceApp.userCartList, [
      "garbageValue"
    ]); //list because cart can contain multiple items garbagevalue is the value affected to the cart before buying
  }
}
