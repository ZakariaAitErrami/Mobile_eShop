...
class _CartPageState extends State<CartPage> {
      ...
      floatingActionButton: FloatingActionButton.extended(
        onPressed: (){
          if(EcommerceApp.sharedPreferences.getStringList(EcommerceApp.userCartList).length == 1){
            //if the length is 1 means no otem in the cart only the garbagevalue
            ...
            child: Consumer2<TotalAmount, CartItemCounter>(builder: (context, amountProvider, cartProvider, c){
              return Padding(
                ...
                child: Center(
                  ...
                  ? Container()
                  : Text(
                    "Total Price ${amountProvider.totalAmount.toString()} MAD",
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text("Cart is empty."),
              Text("Start adding merchandises to your cart")
            ],
          ),
        ),
      ),
  ...
  removeItemFromUserCart(String shortInfoAsId){
    ...
    EcommerceApp.firestore.collection(EcommerceApp.collectionUser)
      ...
      Fluttertoast.showToast(msg: "Merchandise removed Successfully.");
